        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 xl:gap-20 items-center justify-center w-full">
          ...
          <div className="lg:col-span-7 xl:col-span-7 flex flex-col text-center lg:text-left w-full min-w-0">
            ...
            <Reveal direction="up" distance={50} delay={0.15} duration={0.8} className="w-full">
              <h1 className="text-3xl sm:text-7xl md:text-8xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-black tracking-tighter text-white uppercase leading-[0.85] mb-4 sm:mb-6">
          ...
          <Reveal className="lg:col-span-5 xl:col-span-5 w-full flex justify-center lg:justify-start items-center min-w-0" direction="up" distance={40} delay={0.6} duration={0.9}>
            <div className="w-full max-w-lg lg:max-w-none relative group">
              ...
              <div className="glass-panel border border-white/10 rounded-xl overflow-hidden p-2 relative shadow-2xl animate-hud-float will-change-transform">
                ...
                <div className="aspect-video w-full rounded-lg bg-black/50 border border-white/5 relative flex items-center justify-center overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-black/20 group-hover:bg-black/45 transition-all duration-[0.4s] ease-[cubic-bezier(0.16,1,0.3,1)]">
                    <button
                      aria-label="Play showreel"
                      className="w-16 h-16 rounded-full border border-white/20 bg-black/70 backdrop-blur-md flex items-center justify-center group-hover:border-cyber-orange group-hover:scale-110 group-hover:shadow-[0_0_25px_rgba(255,106,1,0.5)] transition-all duration-[0.4s] ease-[cubic-bezier(0.16,1,0.3,1)] pointer-events-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyber-orange"
                    >
